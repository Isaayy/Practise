...
const blueBulbs = document.querySelectorAll<HTMLElement>('.bulb--blue');
const redBulbs = document.querySelectorAll<HTMLElement>('.bulb--red');
...
let interval1: number, interval2: number;
let speed = 1000;
